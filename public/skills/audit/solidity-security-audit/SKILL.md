...
description: >
  Use when auditing EVM Solidity security and users mention: "audit smart contract",
  "review Solidity", "find vulns", "check reentrancy", "analyze gas", "access control",
  "proxy patterns", "DeFi security", "review ERC20/ERC721", "oracle manipulation",
  "upgrade patterns", "slither", "echidna", "foundry fuzz", "formal verification",
  "invariant testing", "flash-loan attack", "MEV", "sandwich attack", "front-running",
  "delegatecall", "selfdestruct", "reentrancy guard", "access vuln", "storage collision",
  "proxy upgrade", "contract exploit", "L2 security", "cross-chain", "bridge security",
  "sequencer risk", "LayerZero", "CCIP", "account abstraction", "ERC-4337", "smart account",
  "paymaster", "bundler", "UserOperation", "re-audit", "diff audit", "remediation review",
  "fix verification", "Uniswap v4 hooks", "Chainlink integration", "Aave integration",
  "flash loan receiver", "ERC-4626 vault", "restaking", "EigenLayer",
  "severity classification", "severity decision", "is this safe?", "any issues here?".
---
